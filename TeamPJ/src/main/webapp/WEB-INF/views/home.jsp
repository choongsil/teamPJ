...
<head>
    ...
    <title>QUOTE - By Distinctive Themes</title>
    ...
    $(document).ready(function(){
          ...
          <c:url value="/resources/assets/img/portfolio/folio01.jpg"/>,
          <c:url value="/resources/assets/img/portfolio/folio05.jpg"/>,
          <c:url value="/resources/assets/img/portfolio/folio03.jpg"/>,
          <c:url value="/resources/assets/img/portfolio/folio04.jpg"/>
   		...
   		<div class="container">
			...
			<div class="row gap">
				<div class="col-md-2 nopadding">
					<p class="post-details">Project Type <strong>Photography</strong></p>
					<p class="post-details">Published <strong>14th July 2014</strong></p>
					<p class="post-details">Tags <strong>Blog, Post, Item</strong></p>	
					<p class="post-details">Client <strong>MicroCorp</strong></p>					
				</div>
				...
				<div class="col-md-10 post-content">
					...
					<nav class="mt gap">
						<ul class="post-navigation">			
							<li class="nav-previous previous previous-post">
								<h4 class="post-nav-title">Previous Project</h4>
								<a href="#" rel="prev">Another Wonderful Project</a>
							</li>			
							<li class="nav-next next next-post">
								<h4 class="post-nav-title">Next Project</h4>
								<a href="#" rel="next">Another Wonderful Project</a>
							</li>			
						</ul>
					</nav>
